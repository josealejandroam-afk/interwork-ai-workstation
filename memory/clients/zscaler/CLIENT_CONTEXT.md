---
name: zscaler
description: "Zscaler client profile, contacts, locations, project history, and operational notes"
metadata:
  node_type: memory
  type: reference
  status: active
...
- **Client name:** Zscaler
- **Active project:** 7413 - Santa Clara / San Jose HQ Move
- **Primary program:** Multi-phase headquarters relocation and decommission

## Client Contacts

| Name | Role | Notes |
|---|---|---|
| Travis Bryant | Senior Manager, Americas Workplace Operations | Primary contact identified in the handoff |
| Sheil Patel | Senior Manager, Workplace Projects | Project stakeholder |
| Jenny Bailey | Needs confirmation | Project stakeholder |
| Julissa Sandoval | Needs confirmation | Project stakeholder |
| Sarah Ablao | Needs confirmation | Project stakeholder |
...
Exact project roles and field assignments remain Needs confirmation unless documented in the project record.
...
- The engagement includes move management, communications, phone booths, lab/server equipment, decommissioning, crate logistics, signage, inventory, and building-access coordination.
