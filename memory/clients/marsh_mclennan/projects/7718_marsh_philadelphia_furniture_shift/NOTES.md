# Project 7718 — Philadelphia Furniture Shift Notes

## September 10, 2026 | Claude Code

Project created fresh from Alejandro's detailed handoff (source: project team discussion / Jane Bae's request, routed through Alejandro). Confirmed via search that no existing folder, stub, or Supabase record existed for #7718 — nothing to reconcile against; this is the first filing.

Filed as: number 7718, "Marsh - Philadelphia, PA - Furniture Shift," 30 South 17th Street, 17th Floor, Philadelphia PA 19103, phased furniture-shift/carpet-replacement-support scope tied to the MMC Philadelphia water-damage restoration. All 15 open items from the handoff carried into OPEN_LOOPS.md verbatim and unresolved. Approximately 6 phases, late-September start discussion, and prior October/November estimates are all recorded as unconfirmed per the handoff's explicit instruction — none of these should be treated as facts in future sessions.

**Flag for future sessions — do not resolve by inference:** the handoff notes conflicting floor information. #7718's confirmed site is 30 South 17th Street, 17th Floor. Separate drawings tied to the broader MMC Philadelphia water-damage restoration reference furniture work on Floors 23-26 (chair moves between 23/24 and 25/26, monitor/monitor-arm moves, Floor 23 table moves and backfill, AV/conference-room support). These Floor 23-26 items are NOT part of 7718's confirmed scope and must not be merged into it, assumed to be the same floors, or treated as InterWork responsibility, until Alejandro or the client explicitly confirms the relationship (this is open item #13). A future session seeing "Philadelphia" and "Marsh" on both should not assume they're the same workstream.

No InterWork PM/field lead has been assigned — David Steinbrecher, Francisco Vinueza, and InterWork Operations are named as participants in the handoff, not as an assignment. Do not infer a PM from that list (open item #14).

## September 10, 2026 (later) | Claude Code — schedule coordination update

Latest coordination confirms the team is still treating **Thursday, 10/8/26** as the working Phase 1 start if the carpet arrives as expected, but they do **not want to formally revise the full phasing schedule yet** — recommendation is to wait until approximately 1.5 weeks before execution, when material delivery is more certain. This is a tentative working date, not a confirmed start (open item #2 stays open).
