# Open Loops — Project 7189 MMC Bermuda Hoboken

| # | Item | Owner | Status |
|---|---|---|---|
| 1 | Confirm Jairo Escalante is briefed and confirmed for July 1 | Hunter Barbieri | Open |
| 2 | Get Jairo Escalante phone number | Alejandro / Hunter | Open |
| 3 | Confirm start time for July 1 at 121 River St | Alejandro | Open |
| 4 | Confirm building access at 121 River St, Hoboken | Alejandro / Hunter | Open |
...
| 8 | ~~Ops huddle (7/10) raised an open "who's going back to Bermuda" question~~ | **Resolved 2026-07-15** — Francisco Vinueza will most likely be PM in Bermuda; Pedro Martinez is onsite lead for the Hoboken loading portion specifically. Two different roles/locations, not a conflict. See item 9. |
| 9 | ~~PM for the Hoboken loadout portion~~ | **Resolved 2026-07-15 (Alejandro):** role split confirmed — **Pedro Martinez = onsite lead for the Hoboken loading portion.** **Francisco Vinueza = PM in Bermuda** (overall project), matching Supabase's existing pm_id. No Supabase change needed — Francisco was already correct as overall PM; Pedro's role is onsite/operational for Hoboken specifically, not a competing overall-PM claim. |
| 10 | **Joe Vieira — freight rates, customs duty, container holding charges, trucking contact all overdue** (per 7/15 meeting) | Joe Vieira | **Open — overdue** |
| 11 | **4 tiger boxes missing after donation transfer — daily rental charges accruing** | Francisco Vinueza | **Open — financial urgency, accruing daily cost** |
