# Project 7573 — Bell Bank: Tampa Decommission/Move to Mendota Heights, MN
...
Two quotes exist under this project number:

| Quote | Scope | Status | Amount |
|---|---|---|---|
| 8531-01 | Move order | **Won** | $20,824.08 |
| 8512-01 | Decom order | **Pending** | $21,365.63 |

Decom scope (8512-01) is not yet confirmed as awarded — do not assume it's proceeding
alongside the move order until confirmed.

## Scope / Inventory

Full itemized inventory captured from Quote 8531-01: desks, chairs, filing cabinets, tables,
appliances, artwork, security equipment. (Full line-item list not transcribed here — refer to
the source quote if the complete itemization is needed.)

**Volume estimate:** ~1,900 cu ft packed (planning-level). Suggests one 53' dry van trailer.
...
- **Cubicle Solutions Inc.** — Steve Ouellet, Branch/Account Manager, 603-365-7407,
  souellet@cubicle-solutions.com, 1909 N US Hwy 301 Suite 150, Tampa FL 33619. Being asked
  for labor and material support (Tampa side). Inquiry drafted, not sent — see DRAFTS.md.
- **Sunset (Peter)** — being asked for a long-haul transport quote, Tampa to Mendota
  Heights. Quote request drafted, not sent — see DRAFTS.md.
