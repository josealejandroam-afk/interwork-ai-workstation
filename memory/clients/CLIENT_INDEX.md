...
| Radian | radian/ | 7492, 7700 | 7492 = Denver decom. 7700 = Bethesda move/decom in planning; Quote 8677 is a $0 blank scope shell. 9/8 walkthrough occurred, COI resolved (Bethesda Crossing EW Acquisition LLC = certificate entity, EW Tower(s) = building reference). Still open: loading dock week, 9/14-9/15 start/POC, walkthrough findings, scope classification (decom vs. packing/storage). |
