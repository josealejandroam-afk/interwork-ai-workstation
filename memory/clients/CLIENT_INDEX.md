...
|---|---|---|---|
| Marsh McLennan (MMC / MMA) | marsh_mclennan/ | 7189, 7060, 7378, 7364, 7431, 7407, 7437, 7486, 7471, 7418, 7354, 7434, 7495, 7447, 7191, 7521, 7576, 7299, 7241, 7494, 7465, 7472, 7484, 7556, 7347, 7553, 7659, 7643, MMA Chicago TBD, Rancho Cordova decom TBD | MMC = Marsh McLennan Company; MMA = Marsh & McLennan Agency. Same parent. Multiple ongoing engagements across US offices. 7347 = McLean VA consolidation, active Wilmington AV recovery (added 2026-07-10, removed from batch-completion approval). 7553 = Dallas decom, merged in 2026-07-10 from the former mcgriff/ folder. 7659 = Hattiesburg furniture move/decom (number confirmed 2026-08-17; date/scope reconciliation still open). 7643 = Shreveport, LA move & decom, added 2026-08-17, minimal detail so far. The two remaining TBD entries are tentative calendar placeholders added 2026-08-17 from a Jill Buchman Teams request — no project numbers yet. |
...
| Claritev / MultiPlan | claritev_multiplan/ | 7420, 7641, 6836, 6837, Chattanooga TBD | 7420 = Laguna Hills CA decom (folder name says Parsippany — that was a ChatGPT error; confirmed Laguna Hills). 7641 = Jupiter, FL delivery and office remodel, number confirmed 2026-08-17 — resolves an earlier unconfirmed "Jupiter" reference from this same session; specific scope details are flagged as an unverified lead in that project's card, not restated as fact. |
...
| AmTrust Financial | amtrust/ | 7348 (pending), 7502, 7513, 7515, 7536, 7568, 7572, 7593, 7594, 7624, Chicago TBD | 7348 = Cleveland/Princeton (location mismatch — confirm); 7502 = Garden Grove CA; 7513 = Southington CT; 7515 = New York NY; 7536 = NYC or Melville; 7568 = Irvine CA; 7572 = 59 Maiden Lane NYC 6/24 (confirmed AmTrust via FastField); 7593 = Jersey City to Southington CT chair move, PM needs reassignment; 7594 = Nashua NH e-waste/furniture disposal + reception desk replacement, execution date not yet set; 7624 = Las Vegas decommission, 6292 W. Spring Mountain Rd, added 2026-07-30 (distinct from the unnumbered "Las Vegas Task Chairs" TBD project also under this client). Chicago TBD = tentative calendar placeholder added 2026-08-17 (Jill confirmed a project number for this already exists — needs lookup, not yet found). |
| Dropbox | dropbox/ | 7399, 7460, 7467, 7547, 7552, furniture pickup/storage TBD | SF-area + 7467 = Seattle Studio Move 2026-04-27. Possibly overlaps with Pear VC origin building at 1800 Owens St. 7547 = Power Beam Install (was missing from this list). Furniture pickup/storage TBD = tentative calendar placeholder added 2026-08-17, Jairo Escalante assigned — may or may not relate to an existing numbered project here, unconfirmed. |
