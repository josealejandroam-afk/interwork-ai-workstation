# Project 7588 — CRC Group Glen Allen, VA Move
...
This project was previously flagged as an unresolved discrepancy: a proposal referenced
project #7588 for this Glen Allen, VA job, while a Smartsheet row for the same date/location/
description showed #7855 instead. **Alejandro confirmed 7588 is the real number** and has
corrected the Smartsheet calendar accordingly. The stale `7855` reference in
`memory/shared/CALENDAR_SNAPSHOT.md` has been updated to match.
