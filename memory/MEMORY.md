...
- [Post-FastField Teams Notification Standard](procedures/post_fastfield_teams_notification_standard.md) — canonical fixed wording for the separate Teams notice sent after a PM's FF assignment is dispatched
