...
| `marsh_mclennan` | TBD | `unknown_chicago_office_transition_phase1` | MMA Chicago Office Transition Phase 1 — 500 W Monroe closure/decom, IT relocation to Orland Park, Canal legacy + reuse inventory (temp storage location unconfirmed), hoteling at Canal 9/14; full schedule 9/8-10/1; 20 open items, project number not yet assigned | `memory/clients/marsh_mclennan/projects/unknown_chicago_office_transition_phase1/PROJECT_CARD.md` |
