...
- 7700: `memory/clients/radian/projects/7700_radian_bethesda_move_decom/PROJECT_CARD.md` — Quote 8677, planning stage; 9/8 walkthrough occurred, COI resolved (EW Tower(s) = building, Bethesda Crossing EW Acquisition LLC = certificate entity). Still open: loading dock week, 9/14-9/15 start/POC, walkthrough findings, scope classification (decom vs. packing/storage).
