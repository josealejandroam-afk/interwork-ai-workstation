...
| AmTrust | Nashua e-waste | Quote not sent — David never got back to Alexis (noted 2026-06-23) | Open | `memory/clients/amtrust/projects/unknown_nashua_ewaste/OPEN_LOOPS.md` |
| AmTrust | Nashua e-waste | Site walk decision needed before quoting | Open | `memory/clients/amtrust/projects/unknown_nashua_ewaste/OPEN_LOOPS.md` |
...
| AmTrust | `unknown_nashua_ewaste` | No record |
