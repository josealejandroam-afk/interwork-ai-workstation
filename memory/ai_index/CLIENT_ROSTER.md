...
|---|---|---|---|---|---|
| Marsh McLennan (MMC/MMA) | `marsh_mclennan` | 7189, 7060, 7378, 7364, 7431, 7407, 7437, 7486, 7471, 7418, 7354, 7434, 7495, 7447, 7191, 7521, 7576, 7299, 7241, 7494, 7465, 7472, 7484, 7556 | `claude_project_bootstraps/marsh_mclennan_bootstrap.md` | `claude_project_packs/marsh_mclennan_knowledge_pack.md` | `memory/clients/marsh_mclennan/CLIENT_CONTEXT.md` |
