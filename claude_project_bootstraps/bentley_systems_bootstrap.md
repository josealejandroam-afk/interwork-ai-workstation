# Bentley Systems — Claude Project Bootstrap
_Upload this file to the "Bentley Systems" Claude Project. Do not re-upload unless routing changes._
...
3. **Bentley Systems client context:**
   `https://raw.githubusercontent.com/josealejandroam-afk/interwork-ai-workstation/main/memory/clients/bentley_systems/CLIENT_CONTEXT.md`
...
| Project | Slug |
|---|---|
| 7350 Cesium to Exton | `7350_cesium_to_exton` |
| 7450 (details TBC) | Check client context for current slug |

Fetch pattern:
`https://raw.githubusercontent.com/josealejandroam-afk/interwork-ai-workstation/main/memory/clients/bentley_systems/projects/<slug>/PROJECT_CARD.md`
...
```
Claude Code Handoff — Bentley Systems [project]

New confirmed facts:
- [fact 1]

Update:
memory/clients/bentley_systems/projects/<slug>/PROJECT_CARD.md
```
