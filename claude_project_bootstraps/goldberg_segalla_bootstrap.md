# Goldberg Segalla — Claude Project Bootstrap
_Upload this file to the "Goldberg Segalla" Claude Project. Do not re-upload unless routing changes._
...
- **Name:** Goldberg Segalla
- **Slug:** `goldberg_segalla`
...
3. **Goldberg Segalla client context:**
   `https://raw.githubusercontent.com/josealejandroam-afk/interwork-ai-workstation/main/memory/clients/goldberg_segalla/CLIENT_CONTEXT.md`
...
| Project | Slug |
|---|---|
| 7322 St. Louis May 5 | `7322_may5_st_louis` |
| 7352 Decom White Plains NY | `7352_decom_white_plains` |

Fetch pattern:
`https://raw.githubusercontent.com/josealejandroam-afk/interwork-ai-workstation/main/memory/clients/goldberg_segalla/projects/<slug>/PROJECT_CARD.md`
...
```
Claude Code Handoff — Goldberg Segalla [project]

New confirmed facts:
- [fact 1]

Update:
memory/clients/goldberg_segalla/projects/<slug>/PROJECT_CARD.md
```
