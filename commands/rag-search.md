...
Run: `uv run python "C:\Users\1\.claude\rag\search.py" "<query>"` from the rag directory.
...
To re-index after memory changes: `uv run python "C:\Users\1\.claude\rag\ingest.py"`
To full rebuild: `uv run python "C:\Users\1\.claude\rag\rebuild.py"`
To watch for changes: `uv run python "C:\Users\1\.claude\rag\watch.py"`
